...
command = 'mp4dash --mpd-name myvideo.mpd --encryption-key=121a0fca0f1b475b8910297fa8e0a07e:a0a1a2a3a4a5a6a7a8a9aaabacadaeaf myvideo_1920x1080_frag.mp4'
os.system(command)

# I have tried to decryot the video but I have no enough time to finish this part
data_folder = Path("./output/")
file_to_open = data_folder / "myvideo.mpd"

# If the dectrypted video al ready exists from previous executions we erase it.
...
command = 'mp4decrypt --key 121a0fca0f1b475b8910297fa8e0a07e:a0a1a2a3a4a5a6a7a8a9aaabacadaeaf {} myvideo_decrypted.mpd'.format(file_to_open)
print('DECRYPTED')
os.system(command)